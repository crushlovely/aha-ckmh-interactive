// Content for /v7 — Unified body, audience-aware, scale-anchored Venn.
//
...
export const v7Content = {
  ...
  // Scene 4 — Stat guess + cascading reveal (pinned interactive)
  guess: {
    ...
    answer: '9 in 10',
    correctVerdict: 'You called it.',
    incorrectVerdict: 'Actually, it’s higher than most people guess.',
...
const COOKIE_NAME = 'ckmh_v7_persona'
